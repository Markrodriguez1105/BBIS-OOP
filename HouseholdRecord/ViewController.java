...
public class ViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // Adjust the table view's width and height dynamically
        initializeTableView();
    ...
    public void populateForm(DataModel selectedData) {
        ...
        zone.setText(String.valueOf(selectedData.getZone()));
        ...
        String familyName = selectedData.getLast_name().toUpperCase();
        showFamilyFirstName.setText(familyName);

        // Convert Date to LocalDate
        LocalDate dateRegistered = selectedData.getDate_registered(); // Assuming getDateRegistered() returns a LocalDate object
